"""
Django settings for kata_tdd project.
...
SECRET_KEY = '+&_gho=2&!0!@ljo&t$my_#r9kzp^st)@4sv1m7p7%%(urpax2'
...
WSGI_APPLICATION = 'kata_tdd.wsgi.application'
